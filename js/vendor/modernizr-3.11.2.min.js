...
- The vendor directory can be used to contain all 3rd party library code.
- HTML5 Boilerplate includes own custom Moderizr build
-Modernizr is a JavaScript library that detects the features available in a user's browser.
This lets web pages avoid unsupported features by informing the user their
browser isn't supported or loading a polyfill.
- Modernizer is a collection of superfast tests – or “detects”
which run as your web page loads, then you can use the results to tailor
the experience to the user... the results show up in the console as a classes before
the head
